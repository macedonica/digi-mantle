          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto space-y-8">
              <h2 className="text-3xl font-bold">
                {t('Нашата Мисија', 'Our Mission')}
              </h2>
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  {t(
                    'Нашата мисија е да го зачуваме богатото културно и историско наследство на македонскиот народ преку дигитализација на книги, рописи, слики и документи. Ги правиме овие материјали достапни за истражувачи, студенти и сите оние што се заинтересирани за нашата историја и култура.',
                ...
                return (
                  <div key={index} className="card-elevated p-6 text-center space-y-4">
                    ...
                    <h3 className="text-xl font-bold">
                      {value.title[t('mk', 'en') as 'mk' | 'en']}
                    </h3>
                    <p className="text-muted-foreground">
                      {value.description[t('mk', 'en') as 'mk' | 'en']}
                    </p>
                  </div>
                );
              })}
